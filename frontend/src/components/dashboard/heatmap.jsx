...
export default function Heatmap({ data }) {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      {/* STATS */}
      <div className="flex flex-wrap justify-center gap-6 sm:gap-10 mb-8 sm:mb-10 text-center">
        <div>
          <p className="text-xs sm:text-sm text-gray-500">Current Streak</p>
          <p className="text-lg sm:text-xl font-bold">{currentStreak} days</p>
        </div>
        <div>
          <p className="text-xs sm:text-sm text-gray-500">Longest Streak</p>
          <p className="text-lg sm:text-xl font-bold">{longestStreak} days</p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-center items-center gap-2 mt-6 text-xs text-gray-500">
        Less
        <div className="w-3 h-3 sm:w-4 sm:h-4 bg-gray-200 dark:bg-white/10"></div>
        <div className="w-3 h-3 sm:w-4 sm:h-4 bg-green-300"></div>
      ...
      {/* SUMMARY */}
      <div className="text-center mt-8 sm:mt-10 text-xs sm:text-sm text-gray-500">
        This week: {activeDays} active days • {total} total activity
      </div>

      {/* AI INSIGHT */}
      <div className="text-center mt-4 sm:mt-6 text-sm sm:text-base text-purple-600 dark:text-purple-400 font-medium px-2">
        {insight}
      </div>
    </motion.div>
  );
